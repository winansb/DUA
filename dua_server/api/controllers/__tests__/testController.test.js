...
describe("testController", () => {
  ...
  describe("createTest", () => {
    ...
    it("should return an error if there is a server error", async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({
        error: "Error in testController - createTest",
      });
  ...
  describe("updateTest", () => {
    ...
    it("should return an error if the test is not found", async () => {
      ...
      expect(res.send).toHaveBeenCalledWith({
        error: "TestController - updateTest: Test not found",
      });
    });
    ...
    it("should return an error if there is a server error", async () => {
      ...
      expect(res.status).toHaveBeenCalledWith(500);
      expect(res.send).toHaveBeenCalledWith({
        error: "Error in testController - updateTest",
      });
    });
  });
  ...
  describe("updateBreakdownTestId", () => {
    ...
    it("should return an error if the test is not found", async () => {
      ...
      const req = {
        params: { uid: testUID + 1 },
        body: { breakdownTestId: 1 },
      };
      const res = {
        status: jest.fn().mockReturnThis(),
        send: jest.fn().mockReturnThis(),
      ...
      expect(res.status).toHaveBeenCalledWith(404);
      expect(res.send).toHaveBeenCalledWith({
        error: "TestController - updateBreakdownTestId: Test not found",
      });
    });
    ...
    it("should return an error if there is a server error", async () => {
      ...
      expect(res.status).toHaveBeenCalledWith(500);
      expect(res.send).toHaveBeenCalledWith({
        error: "Error in testController - updateBreakdownTestId",
      });
    });
    ...
    describe("updateDetourTestId", () => {
      ...
      it("should return an error if the test is not found", async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(404);
        expect(res.send).toHaveBeenCalledWith({
          error: "testController - updateDetourTestId: Test not found",
        });
      });
      ...
      it("should return an error if there is a server error", async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(500);
        expect(res.send).toHaveBeenCalledWith({
          error: "Error in TestController - updateDetourTestId",
        });
      });
    });
