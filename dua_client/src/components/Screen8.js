...
import styles from '../css/Screen8.module.scss';

export default function Screen8(props) {
  return (
    <div className={cn(styles.root, 'screen8')}>
      <div className={styles.row}>
        <div className={styles.col}>
          ...
          <div className={styles.box}>
            <img className={styles.image} src={require("../assets/d0d40d3e635827df1844e98571b9768e.png")} alt="alt text" />

            <div className={styles.row1}>
              <div className={styles.row1__item}>
                <img
                  className={styles.image4}
                  src={require("../assets/286eb605f769fc6a61aeb3391b130b18.png")}
                  alt="alt text"
                />
              </div>
              ...
              <div className={styles.col1}>
                <div className={styles.col1__item}>
                  <div className={styles.box4}>
                    <px-grid track-style="flex-grow: 1;" x="29px 688fr 30fr" y="16px minmax(265px,265fr) 32fr">
                ...
                <div className={styles.col1__item}>
                  <div className={styles.box3}>
                    <px-grid track-style="flex-grow: 1;" x="29px 688fr 30fr" y="74px minmax(238px,238fr) 71fr">
                      <h1 className={styles.hero_title1_box}>
                        <div className={styles.hero_title1}>
                          <span className={styles.hero_title1_span0}>
                            Trip Information:
        ...
        <div className={styles.col2}>
          <div className={styles.col2__item}>
            <div className={styles.box2}>
              <px-grid track-style="flex-grow: 1;" x="109fr 300fr 109fr" y="40px minmax(36px,36fr) 40fr">
            ...
            <div className={styles.col3}>
              ...
              <div className={styles.content_box2}>
                <div className={styles.row4}>
                  ...
                  <h1 className={styles.big_title12}>Vehicle Setting</h1>
                </div>
              </div>
              ...
              <div className={styles.content_box3}>
                <div className={styles.row5}>
                  ...
                  <h1 className={styles.big_title13}>Call</h1>
                </div>
              </div>
            </div>
          </div>
