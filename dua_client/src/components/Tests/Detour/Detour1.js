      ...
      <div className={css(styles.group)}>
        ...
        <div className={css(styles.group1)}>
                  ...
                  <div className={css(styles.flexCol)}>
                    <div className={css(styles.flexCol1)}>
                      <div className={css(styles.wrapper)}>
                        <h1 className={css(styles.wrapper1)}>We have detected a road blockage ahead</h1>
                      </div>

                      <div className={css(styles.wrapper2)}>
                        <h1 className={css(styles.wrapper1)}>that is preventing us from driving.</h1>
                      </div>
                    </div>

                    <div className={css(styles.box3)} onClick={props.Detour1_Ok}>
          ...
          <div className={css(styles.flexRow5)}>
            <h1 id="destination2" className={css(styles.big_title2)}>{props.destination}</h1>
            <div className={css(styles.flexRow5__spacer)} />
            <h1 id="ArrivalTime2" className={css(styles.big_title3)}>{props.ArrivalTime}</h1>
          </div>
        </div>
      </div>
    </div>
