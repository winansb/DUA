...
export default function Detour7(props) {
  return (
    <div className={cn(css(styles.root), 'detour7')}>
      <div className={css(styles.flexRow)}>
        <div className={css(styles.flexCol)}>
          <div className={css(styles.content_box1)}>
            <div className={css(styles.flexCol1)}>
              <h1 className={css(styles.hero_title1)}>Your final destination is home</h1>
              <h1 id="ArrivalTime6" className={css(styles.hero_title11)}>{props.ArrivalTime}</h1>
            </div>
          </div>
          ...
          <div className={css(styles.box)}>
            <div className={css(styles.content_box)}>
              <div className={css(styles.flexCol2)}>
                <img
                  src={require('./assets/5ca20ef25262ad6db3c6cb956567bf43.png')}
                  alt="alt text"
                  className={css(styles.image3)}
                />

                <div className={css(styles.flexCol3)}>
                  <h1 className={css(styles.hero_title12)}>Would you like to return home?</h1>
                  <px-grid x="129fr 873px 106fr" y="0px 100px 0px">
                    <div className={css(styles.flexRow1)}>
                      <div className={css(styles.box3)} onClick={props.Detour7_Yes}>
                        <h1 className={css(styles.hero_title2)}>Yes</h1>
                      </div>

                      <div className={css(styles.flexRow1__spacer)} />

                      <div className={css(styles.box4)} onClick={props.Detour7_No}>
