...
export default function Breakdown9(props) {
  return (
    <div className={cn(css(styles.root), 'breakdown9')}>
      <div className={css(styles.flexRow)}>
        <div className={css(styles.flexRow__item)}>
          <div className={css(styles.flexCol)}>
            <h1 className={css(styles.big_title)}>Monday, Jan 16, 10:33 AM</h1>
            ...
            <div className={css(styles.box)}>
              <div className={css(styles.group)}>
                <div className={css(styles.rect)} />

                <div className={css(styles.flexCol1)}>
                  <div className={css(styles.flexCol2)}>
                    <h1 className={css(styles.hero_title2)}>No more immediate action is required</h1>
...
const styles = StyleSheet.create({
  ...
  group: {
    ...
    position: 'relative',
    flexGrow: 1,
    margin: '73px 38px 71px',
    '@media (max-width: 1199px)': {
      margin: '73px 32px 71px'
    },
    '@media (max-width: 991px)': {
      margin: '73px 24px 71px'
    },
    '@media (max-width: 767px)': {
      margin: '73px 20px 71px'
    },
    '@media (max-width: 479px)': {
      margin: '73px 16px 71px'
    }
  },
  rect: {
    backgroundColor: 'rgb(255,255,255)',
