...
export default function Breakdown2(props) {
  return (
    <div className={cn(css(styles.root), 'breakdown2')}>
      <div className={css(styles.flexRow)}>
        <div className={css(styles.flexRow__item)}>
          <div className={css(styles.flexCol)}>
            <div className={css(styles.flexCol1)}>
              <h1 className={css(styles.big_title)}>Monday, Jan 16, 10:31 AM</h1>
                  ...
                  <div className={css(styles.flexCol2)}>
                    <div className={css(styles.flexCol3)}>
                      <div className={css(styles.wrapper)}>
                        <h1 className={css(styles.hero_title)}>Please stay calm and remain inside the car</h1>
                      </div>

                      <div className={css(styles.wrapper1)}>
                        <h1 className={css(styles.hero_title)}>while we solve the issue.</h1>
                      </div>
                    </div>
        ...
        <div className={css(styles.flexRow__item1)}>
          <div className={css(styles.flexCol4)}>
            <div className={css(styles.wrapper11)}>
              <h1 className={css(styles.hero_title1)}>Help</h1>
            </div>
...
const styles = StyleSheet.create({
  ...
  flexRow: {
    ...
    position: 'relative',
    minWidth: 1859,
    margin: '6px 23px 52px 38px',
    '@media (max-width: 1199px)': {
      margin: '6px 23px 52px 32px'
    },
    '@media (max-width: 991px)': {
      margin: '6px 16px 52px 24px'
    },
