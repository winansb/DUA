...
export default function Breakdown3(props) {
  return (
    <div className={cn(css(styles.root), 'breakdown3')}>
            ...
            <div className={css(styles.box)}>
              <div className={css(styles.content_box)}>
                <div className={css(styles.flexCol2)}>
                  <h1 className={css(styles.hero_title)}>Would you like to pull over the vehicle?</h1>
