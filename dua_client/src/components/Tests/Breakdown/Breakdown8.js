...
export default function Breakdown8(props) {
  return (
    <div className={cn(css(styles.root), 'breakdown8')}>
            ...
            <div className={css(styles.flexRow2)}>
              <div className={css(styles.flexRow2__item)}>
                <img
                  ...
                  src={require('../../../assets/aed21713efaa53e1041e1fdd70b022d4.png')}
                  alt="alt text"
                />
              </div>
...
const styles = StyleSheet.create({
  ...
  flexCol3: {
    ...
    position: 'relative',
    flexGrow: 1,
    margin: '51px 29px 65px 30px',
    '@media (max-width: 1199px)': {
      margin: '51px 24px 65px'
    },
    '@media (max-width: 991px)': {
      margin: '51px 20px 65px'
    },
    '@media (max-width: 767px)': {
      margin: '51px 16px 65px'
    },
    '@media (max-width: 479px)': {
      margin: '51px 12px 65px'
    }
  },
  hero_title2: {
    display: 'flex',
  ...
  flexCol4: {
    ...
    position: 'relative',
    flexGrow: 1,
    margin: '36px 29px 66px 30px',
    '@media (max-width: 1199px)': {
      margin: '36px 24px 66px'
    },
    '@media (max-width: 991px)': {
      margin: '36px 20px 66px'
    },
    '@media (max-width: 767px)': {
      margin: '36px 16px 66px'
    },
    '@media (max-width: 479px)': {
      margin: '36px 12px 66px'
    }
  },
  hero_title3: {
    display: 'flex',
