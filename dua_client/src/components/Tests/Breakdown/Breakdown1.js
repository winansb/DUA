...
export default function Breakdown1(props) {
  return (
    <div className={cn(css(styles.root), 'breakdown1')}>
                ...
                <div className={css(styles.content_box)}>
                  <div className={css(styles.flexCol2)}>
                    <div className={css(styles.flexCol3)}>
                      <h1 className={css(styles.hero_title)}>We have detected an issue with the</h1>
                      <h1 className={css(styles.hero_title1)}>
                        <br />
        ...
        <div className={css(styles.flexRow__item1)}>
          <div className={css(styles.flexCol4)}>
            <div className={css(styles.wrapper)}>
              <h1 className={css(styles.hero_title11)}>Help</h1>
            </div>
