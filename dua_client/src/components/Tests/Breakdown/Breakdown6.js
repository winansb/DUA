...
export default function Breakdown6(props) {
  return (
    <div className={cn(css(styles.root), 'breakdown6')}>
                ...
                <div className={css(styles.flexRow2__item)}>
                  <div className={css(styles.group)}>
                    <img
                      ...
                      src={require('../../../assets/da1c87878a56f5ce6be1cafece35e9f3.png')}
                      alt="alt text"
                    />

                    <div className={css(styles.content_box)}>
                      <h1 className={css(styles.big_title2)}>Emergency Contact</h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div className={css(styles.flexCol2)}>
                    <div className={css(styles.box3)}>
                      <div className={css(styles.flexCol3)}>
                        <h1 className={css(styles.hero_title2)}>
                          Situation Description:
                          <br />
                        </h1>
                        <h1 className={css(styles.hero_title1)}>There is an issue with my vehicle that</h1>
                        <h1 className={css(styles.hero_title11)}>is preventing me from driving.</h1>
                      </div>
                    </div>

                    <div className={css(styles.box2)}>
                      <div className={css(styles.flexCol4)}>
                        <h1 className={css(styles.hero_title2)}>Trip Information:</h1>
                        <h1 className={css(styles.hero_title3)}>Destination: Walgreens</h1>
                        <h1 className={css(styles.hero_title31)}>Current Location: SE 2nd Avenue</h1>
                        <h1 className={css(styles.hero_title31)}>ETA: 3 Minutes</h1>
                      </div>
                    </div>
                  </div>
                </div>
...
const styles = StyleSheet.create({
  ...
  flexCol3: {
    ...
    position: 'relative',
    flexGrow: 1,
    margin: '47px 30px 69px 29px',
    '@media (max-width: 1199px)': {
      margin: '47px 24px 69px'
    },
    '@media (max-width: 991px)': {
      margin: '47px 20px 69px'
    },
    '@media (max-width: 767px)': {
      margin: '47px 16px 69px'
    },
    '@media (max-width: 479px)': {
      margin: '47px 12px 69px'
    }
  },
  hero_title2: {
    display: 'flex',
  ...
  flexCol4: {
    ...
    position: 'relative',
    flexGrow: 1,
    margin: '50px 29px 52px 30px',
    '@media (max-width: 1199px)': {
      margin: '50px 24px 52px'
    },
    '@media (max-width: 991px)': {
