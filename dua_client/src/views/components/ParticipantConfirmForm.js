    ...
    <Container>
      ...
      <InfoContainer>
        <InfoRow>
          ...
          <InfoLabel>{column === 0 ? 'Detour Option 1' : 'Breakdown Option 1'}</InfoLabel>
          <InfoLabel>{column === 0 ? 'Detour Option 2' : 'Breakdown Option 2'}</InfoLabel>
          <InfoLabel>{column === 0 ? 'Detour Option 3' : 'Breakdown Option 3'}</InfoLabel>
        </InfoRow>
        <InfoRow>
          ...
          <InfoData>{test[column === 0 ? 'DETOUR_OPTION_1' : 'BREAKDOWN_OPTION_1']}</InfoData>
          <InfoData>{test[column === 0 ? 'DETOUR_OPTION_2' : 'BREAKDOWN_OPTION_2']}</InfoData>
          <InfoData>{test[column === 0 ? 'DETOUR_OPTION_3' : 'BREAKDOWN_OPTION_3']}</InfoData>
        </InfoRow>
      </InfoContainer>
      <Buttons>
