...
export const screenController = {
  createScreen: async (newScreen) => {
    try {
      ...
      console.error(
        "screenController - createScreen : Error creating screen:",
        error
      );
      throw error;
    }
  ...
  finishScreen: async (uid) => {
    try {
      ...
      console.error(
        `screenController - finishScreen :Error finishing screen ${uid}:`,
        error
      );
      throw error;
    }
  ...
  getScreen: async (uid) => {
    try {
      ...
      console.error(
        `screenController - getScreen :Error getting screen ${uid}:`,
        error
      );
      throw error;
    }
