...
export const createParticipant = (participantData) => async (dispatch) => {
  try {
    const createdParticipant = await participantController.createParticipant(
      participantData
    );
    dispatch({
...
export const updateParticipant =
  (uid, updatedParticipant) => async (dispatch) => {
    try {
      const updatedData = await participantController.updateParticipant(
        uid,
        updatedParticipant
      );
      dispatch({
...
export const deleteParticipant = (uid) => async (dispatch) => {
  try {
    const deletedParticipant = await participantController.deleteParticipant(
      uid
    );
    dispatch({
